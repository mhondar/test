class VuelosPage
  ...
  def initialize(browser)
    ...
    @calFechaIda = browser.element(:xpath => "/html/body/div[5]/div[1]/div[1]/table/tbody/tr[4]/td[7]")
    @calFechaReg = browser.element(:xpath => "/html/body/div[6]/div[1]/div[1]/table/tbody/tr[5]/td[7]")
